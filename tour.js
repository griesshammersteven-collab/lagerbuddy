...
function tourDaten(fuer, master) {
  ...
  const offen = { id: 'tour-a', name: 'Beispiel · Pickliste B4 → Bühl', von: 'B4', nach: 'Bühl', fuer, importedAt: t, lines: [
    { lid: 'a1', artikel: '931000136000', bez: '120ml Braunglas', charge: 'L2409', required: 3000, einheit: 'Stück', gebinde: 1000, picked: 3000,
      scans: [s(14, 1000, fuer), s(12, 1000, fuer, { anzahl: 2 })] },
    { lid: 'a2', artikel: '0001446028', bez: 'Kakaobutter', charge: 'K24-117', required: 350, einheit: 'kg', gebinde: 25, picked: 25,
      scans: [s(9, 25, fuer)] },
    { lid: 'a3', artikel: '93100023', bez: 'Sheabutter', charge: 'S0815', required: 60, einheit: 'kg', picked: 0, scans: [] }] };
...
const TOUR_MASTER = [
  ...
  { ziel: '.pick-line.current .pick-edit', vor: () => tourListe('tour-a'), titel: 'Prüfen und korrigieren', text: 'Nach dem Foto-Import kurz gegenchecken: Artikelnummer, Charge und Menge ändern nur Teamleiter.' },
